...
import { EventCard } from '@tsa/shadcnui-signage';
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      <div className="mb-10 space-y-4">
        ...
        <h1 className="text-3xl md:text-4xl font-medium tracking-tight">EventCard</h1>
        <p className="max-w-2xl text-base md:text-lg text-muted-foreground">
          Display event information with time, title, speaker, location, and track for conference schedules and event displays.
        </p>
      </div>
      ...
      <section className="mb-12">
        ...
        <div className="bg-muted p-6 rounded-lg">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <li>Gradient background with accent color bar for track categorization</li>
      ...
      <section className="mb-12">
        ...
        <div className="mb-6">
          ...
          <CodeSnippet
            language="bash"
            code="npx shadcn add https://cambridgemonorail.github.io/TheSignAge/registry event-card"
          />
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-muted-foreground">
              <a
                href="https://github.com/CambridgeMonorail/TheSignAge/blob/main/libs/shadcnui-signage/src/lib/primitives/EventCard.tsx"
                target="_blank"
    ...
    <div className="space-y-4">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-muted-foreground">
          <div><strong className="text-foreground">Track Color Coding:</strong> Predefined colors for common tracks (Keynote, Technical, Design, Business, Social) help attendees quickly identify session types.</div>
          <div><strong className="text-foreground">Time Prominence:</strong> Large time display (4xl) on the left ensures quick scanning for schedule planning.</div>
          <div><strong className="text-foreground">Hierarchical Information:</strong> Title is most prominent (2xl), followed by speaker and room details for logical information priority.</div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-4">
          <Button asChild variant="outline">
            <a href="https://cambridgemonorail.github.io/TheSignAge/storybook/?path=/docs/primitives-eventcard--docs" target="_blank" rel="noopener noreferrer">View in Storybook</a>
          </Button>
          <Button asChild variant="outline">
            <a href="https://github.com/CambridgeMonorail/TheSignAge/blob/main/libs/shadcnui-signage/src/lib/primitives/EventCard.tsx" target="_blank" rel="noopener noreferrer">View Source</a>
          </Button>
        </div>
      </section>
    </div>
