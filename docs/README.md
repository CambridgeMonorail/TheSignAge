...
- **[Theming Your App](./guides/theming-a-new-app.md)** - Shadcn UI and Tailwind CSS customization
...
- **[Manage Keys and Tokens](./integration/manage-keys-and-tokens.md)** - Secure secret management
...
- **Upgrade dependencies** → [Upgrade Notes](./maintenance/UPGRADE_NOTES.md)
...
- **Key Topics** summarize what each document covers
- **Navigation links** at the bottom help you move between related docs
- **"I want to..." sections** provide quick paths to common tasks
